function sendToOwnLockbookIfSignedUp() {
  if(window.localStorage.getItem('user') != null) {
    window.location.href="../Website/Sites/createBook.html";
  } else {
    window.location.href="../Website/Sites/login.html";
  }
}
async function getUserLookbooks() {
  $("#page1")[0].innerHTML = "<div class=\"first\">";
  var janes_lookbook = `<div class="jane-lookbook">
